...
public class WeatherServiceImpl implements WeatherService {
    ...
    public String retrieveWeather(String location) {
        ...
        System.out.println("You should never sysout ;). Test location: " + location);
        return "mock return";
    }
    ...
    public Weather retrieveWeatherForCity (String location) {
        ...
        String uri = appConfig.getApiUrl() + "?q=" + locationToSearch + "&units=metric&APPID=" + appConfig.getApiKey();
