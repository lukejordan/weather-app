...
public class WeatherWebController {
	...
	private static Logger LOGGER = Logger.getLogger(WeatherWebController.class.getName());
	
	@Autowired
	private WeatherService weatherService;

    @RequestMapping(value = "/weather/{location}", method = RequestMethod.GET)
    public String testRetrieveFromDb(@PathVariable("location") final String location, ModelMap model) {
    ...
    //    public String testPersist(@ModelAttribute String location, ModelMap model) {
